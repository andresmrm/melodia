...
class gui():
    def __init__(self, melodia):
        ...
        # builder = Gtk.Builder()
        # self.wTree = builder.add_from_file(self.gladefile)

        # Create our dictionay and connect it
        dic = {
            "on_b1t_toggled": self.tocar1,
    ...
    def salvar_como(self, widget):
        dialog = gtk.FileChooserDialog("Salvar...", None,
